...
<head>
    ...
    <title>KHODAL HOTEL -CONFIRM BOOKING</title>
    ...
    */
    ...
    echo <<<data
            <div class="card p-3 shadow-sm rounded">
             ...
             <h6>INR $room_data[price] per night</h6>
            </div>
          data;
    ?>
            </div>
                        ...
                        <form action="inc/paytm/index.php" method="POST" id="booking_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 p-0 mb-3">
                                    ...
                                    <textarea name="address" class="form-control shadow-none" rows="2"
                                ...
                                <div class="col-12">
                                    ...
                                    <h6 class="mb-3 text-danger" id="pay_info">Provide Check-in and Check-out date !
                                    </h6>
        ...
        if (checkin_val != '' && checkout_val != ''); {
            ...
            xhr.onload = function() {
                ...
                if (data.status == 'check_in_out_equal') {
                    ...
                    pay_info.innerHTML = "No. of Days: " + data.days + "</br>Total Amount to Pay: INR" + data
                        .payment;
