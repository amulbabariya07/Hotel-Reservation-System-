...
<head>
    ...
    <title>KHODAL HOTEL-ABOUT</title>
...
<body class="bg-light">
    ...
    <div class="my-5 px-4">
        ...
        <p class="text-center mt-3">
            Welcome to Khodal Hotel, your sanctuary in the heart of Khodal Dham Kagvad. Experience exceptional
            hospitality and comfort with us. Whether for business or leisure,<BR><br>
            We're here to make your stay unforgettable.</br><br>
            Discover serenity and luxury intertwined at the breathtaking Hotel Khodal, where every moment is an
            exquisite escape. </br>
        </p>
    </div>
